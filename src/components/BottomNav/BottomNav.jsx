    ...
    return (
        <nav className="fixed bottom-0 left-0 w-full bg-white border-t shadow-lg z-50">
            ...
            <div className="max-w-md mx-auto grid grid-cols-4 py-3">
                ...
                <button
                    onClick={() => navigate("/")}
                    className={`flex flex-col items-center ${location.pathname === "/" ? active : normal}`}
                >
                    <House size={22} />
                ...
                <button
                    ...
                    className={`flex flex-col items-center ${location.pathname === "/catalogo" ? active : normal}`}
                >
                    <Cake size={22} />
                ...
                <button
                    ...
                    className={`relative flex flex-col items-center ${location.pathname === "/carrito" ? active : normal}`}
                >
                ...
                <button
                    ...
                    className={`flex flex-col items-center ${location.pathname === "/admin" ? active : normal}`}
                >
                    <User size={22} />
